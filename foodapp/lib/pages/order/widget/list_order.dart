              ...
              ? Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextDarkMode(text: "Chưa có đơn hàng nào được đặt"),
                      SizedBox(
                    ...
                    return Container(
                      ...
                      child: Container(
                        ...
                        child: Column(children: [
                              ...
                              (id) => Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    TextNormal(
                                      text:
                                          "\$${listItem[index].carts[id].dish.price} x ${listItem[index].carts[id].quantity}",
                          ...
                          Container(
                              child: TextNormal(
                            text: "Total: \$${listItem[index].totalprice}",
