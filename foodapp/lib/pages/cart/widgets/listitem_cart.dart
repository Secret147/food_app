    ...
    return widget.orders.isEmpty
        ? Container(
            ...
            child: Column(
              ...
              children: [
                Container(
                  child: Image.asset("assets/images/speech-bubble 1.png"),
                ),
                SizedBox(
                  height: Dimensions.height10,
                ),
                TextDarkMode(text: "Chưa có sản phẩm trong giỏ hàng"),
                SizedBox(
                  height: Dimensions.height40,
                ),
                GestureDetector(
                    onTap: () => context.goNamed("home"),
                    child: ButtonCustom(text: "Thêm sản phẩm"))
              ],
            ),
          )
        : Column(children: [
              ...
              GestureDetector(
                onTap: () {
                  Bill bill = Bill(
                      ...
                      carts: widget.orders,
                      create_at: "");
                  context.goNamed("payment", extra: bill);
                },
                child: Container(
                    margin:
